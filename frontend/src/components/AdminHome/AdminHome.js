  ...
  return (
    <div className="home-container">
      ...
      <div className="admin-buttons-container">
        <button className="admin-button">Appointment Scheduling</button>
        <button className="admin-button">Manage Doctors</button>
        <button className="admin-button" onClick={() => navigate('/treatmentlogin')}>Treatment Specialist</button> {/* Link to AddTreatment */}
        <button className="admin-button">Payment Handling</button>
